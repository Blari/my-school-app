    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
                    ...
                    {users.parents_user &&
                      ...
                      users.parents_user.map((item: any) => (
                        ...
                        >
                          ...
                          <td data-label='animal'>{item.animal}</td>
                        </tr>
                      ))}
                  </tbody>
                </table>
          ...
          <>
            <p className={'block font-bold mb-2'}>Teachers User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.teachers_user &&
                      Array.isArray(users.teachers_user) &&
                      users.teachers_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
                              `/teachers/teachers-view/?id=${item.id}`,
                            )
                          }
                        >
                          <td data-label='first_name'>{item.first_name}</td>
