...
import { create } from '../../stores/grades/gradesSlice';
...
GradesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_GRADES'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default GradesNew;
