...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/classes/classesSlice';
...
const TableSampleClasses = ({
  ...
  const handleViewAction = (id: string) => {
    router.push(`/classes/classes-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {classes && Array.isArray(classes) && !showGrid && (
        <ListClasses
          classes={classes}
          loading={loading}
