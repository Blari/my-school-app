...
const CardUsers = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_GRADES');
              ...
              >
                ...
                <div className='ml-auto '>
                  <ListActionsPopover
                    ...
                    onEdit={onEdit}
                    itemId={item.id}
                    pathEdit={`/grades/grades-edit/?id=${item.id}`}
                    pathView={`/grades/grades-view/?id=${item.id}`}
              ...
              <dl className='divide-y  divide-stone-300   dark:divide-dark-700 px-6 py-4 text-sm leading-6 h-64 overflow-y-auto'>
                <div className='flex justify-between gap-x-4 py-3'>
                  ...
                  <dd className='flex items-start gap-x-2'>
                    <div className='font-medium line-clamp-4'>{item.grade}</div>
                  </dd>
                </div>
                ...
                <div className='flex justify-between gap-x-4 py-3'>
                  ...
                  <dd className='flex items-start gap-x-2'>
                    <div className='font-medium line-clamp-4'>
                      {dataFormatter.assignmentsOneListFormatter(
                        item.assignment,
                      )}
                    </div>
                  </dd>
